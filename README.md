# ⚡ ESP32 Modbus TCP CNC Digital Readout (DRO) & Axis Controller
...
Industrial CNC multi-axis DRO gateway reading quadrature optical linear scales, calculating sub-micron tool offsets, and broadcasting real-time position via Modbus TCP & WebSockets.
...
| 2 | **Modul Transceiver RS485 MAX485 / SP3485** | 1-2 Unit | Komunikasi data serial industri multi-drop jarak jauh |
| 3 | **Resistor Terminasi 120Ω 1/4W** | 2 Unit | Mencegah refleksi sinyal pada ujung kabel RS485 bus |
...
3. Pastikan dependensi pustaka terpasang via Library Manager:
   ...
   * `Wire` & `SPI`
   * `Preferences`
4. Buka berkas [`esp32-modbus-tcp-cnc-dro.ino`](./esp32-modbus-tcp-cnc-dro.ino).
